#
#  Be sure to run `pod spec lint TestSwiftPod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/attackers/TestSwiftPod.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "TestSwiftPod/Classes", "TestSwiftPod/Classes/*.swift"
